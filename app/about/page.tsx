...
export const metadata: Metadata = {
  title: 'Sobre Nós | Plattano Technologies | Parceiro de TI Confiável em Florianópolis',
  description:
  ...
  openGraph: {
    title: 'Sobre a Plattano Technologies | Parceiro de TI Confiável em Florianópolis',
    description:
