export const companyInfo = {
  ...
  vision:
    'Ser o parceiro de TI mais confiável para empresas em Florianópolis e além.',
}
...
export const timeline = [
  {
    ...
    description: 'Iniciamos com a visão de transformar a infraestrutura de TI em Florianópolis',
  },
  {
    year: '2015',
  ...
  },
  {
    year: '2023',
    title: '500+ Clientes',
    description: 'Nos tornamos um dos principais provedores de TI em Florianópolis',
  },
  {
    year: '2025',
...
export const whyChooseUs = [
  ...
  },
  {
    icon: '📍',
    title: 'Suporte Local',
    description: 'Baseados em Florianópolis com equipe multilíngue',
  },
  {
    icon: '⚡',
